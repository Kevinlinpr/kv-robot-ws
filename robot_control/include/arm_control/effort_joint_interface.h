//
// Created by kevinlinpr on 19-4-3.
//

#ifndef KV_DESCRIPTION_EFFORT_JOINT_INTERFACE_H
#define KV_DESCRIPTION_EFFORT_JOINT_INTERFACE_H
#include "ros/ros.h"
#include <kdl/jntarrayvel.hpp>
#include <robot_control/Efforts.h>
...
public:
    ...
    bool init(std::vector<hardware_interface::JointHandle> &joint_handles, ros::NodeHandle &nh)
    {
        ...
        // 将parameter server中/robot_description所对应的URDF文件内容解析成URDF模型
        //initParam将返回bool类型检查此参数是否存在
        ...
        //从KDL中提取链
        KDL::Chain chain;
        //提取link 根节点 toe 和 link 末端节点 finger 所覆盖的整个KDL链条
...
private:
    ...
    typedef realtime_tools::RealtimePublisher<robot_control::Efforts> EffortsPublisher;
...
#endif //KV_DESCRIPTION_EFFORT_JOINT_INTERFACE_H
